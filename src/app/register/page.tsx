    ...
    <div className="min-h-[85vh] flex items-center justify-center p-4">
      <div className="w-full max-w-lg bg-zinc-900/90 border border-zinc-800 rounded-3xl p-6 sm:p-8 shadow-2xl backdrop-blur-md">
        <div className="text-center mb-6">
          ...
          <h1 className="text-2xl font-black text-white">{t.auth_reg_title}</h1>
          <p className="text-xs text-zinc-400 mt-1">{t.auth_reg_subtitle}</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-3.5">
          ...
          <div className="pt-2">
            ...
            >
              <span>{loading ? t.auth_registering : t.auth_reg_submit}</span>
